...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    # num_gt:所有图片的真值框，不是单独一张图片
    # num_det:所有图片的预测框
    print('The sum of gt-boxes in all pictures:', numGlobalCareGt)
    print('The sum of detect-boxes all pictures:', totalNumDetPols)
