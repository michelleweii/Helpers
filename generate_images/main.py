...
def imgExtractRects(labelmeJson, img):
    latexes = [area['label'] for area in labelmeJson['shapes']]
    # print(latexes)
    can_used = [area['points'] for area in labelmeJson['shapes']]
...
def main():
    inputdir = '/Users/admin/Documents/0521/image'
    outputdir = '/Users/admin/Documents/0521/output'
